...
public class Activity_Comments extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PreferenceManager.setDefaultValues(Activity_Comments.this, R.xml.user_settings, false);
        sharedPref = PreferenceManager.getDefaultSharedPreferences(Activity_Comments.this);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(Activity_Comments.this);
                View dialogView = View.inflate(Activity_Comments.this, R.layout.dialog_edit_title, null);
                ...
                dialog.show();
                helper.showKeyboard(Activity_Comments.this,edit_title);
            }
        });

        //calling DbAdapter_Entries
        db = new DbAdapter_Comments(Activity_Comments.this);
        db.open();
    ...
    private void setCommentList() {
        ...
        SimpleCursorAdapter adapter = new SimpleCursorAdapter(Activity_Comments.this, layoutstyle, row, column, xml_id, 0);
